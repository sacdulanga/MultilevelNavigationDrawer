...
public class CustomDataProvider {
    ...
    private static List<BaseItem> getListGroupX(){
        List<BaseItem> list = new ArrayList<>();
        GroupItem groupItem = new GroupItem("GROUP Y");
        groupItem.setLevel(groupItem.getLevel() + 2);
    ...
    private static List<BaseItem> getListGroupY(){
        List<BaseItem> list = new ArrayList<>();
        list.add(new Item("CHILD OF GY-A"));
        list.add(new Item("CHILD OF GY-B"));
